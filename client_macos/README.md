...
- ✅ **GPS карта** - интерактивная карта OpenStreetMap с позицией робота и треком движения
...
- ✅ Интерактивная GPS карта OpenStreetMap
...
- ✅ Добавлена интерактивная GPS карта (OpenStreetMap + Leaflet.js)
